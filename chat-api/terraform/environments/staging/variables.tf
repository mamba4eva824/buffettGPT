...
variable "bedrock_knowledge_base_name" {
  ...
  type        = string
  default     = "buffett-investment-kb-staging"
}

variable "bedrock_knowledge_base_description" {
  description = "Description of the Bedrock knowledge base"
  type        = string
  default     = "Staging: Knowledge base containing Warren Buffett's investment wisdom and market analysis"
}
...
variable "bedrock_guardrail_name" {
  ...
  type        = string
  default     = "buffett-investment-guardrails-staging"
}

variable "bedrock_guardrail_description" {
  description = "Description of the Bedrock guardrail"
  type        = string
  default     = "Staging: Safety guardrails for BuffettGPT investment advisor to ensure responsible financial advice"
}
