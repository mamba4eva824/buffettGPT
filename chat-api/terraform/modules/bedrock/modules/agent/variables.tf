...
# Variables for Agent module

variable "agent_name" {
  description = "Name of the Bedrock Agent"
  type        = string
  default     = "buffett-advisor-dev"
}
...
variable "agent_role_arn" {
  description = "ARN of the service role for the Agent"
  type        = string
}
...
variable "knowledge_base_id" {
  description = "ID of the knowledge base to associate"
  type        = string
  default     = ""
}
...
variable "agent_alias_description" {
  ...
  type        = string
  default     = "Development alias for Warren Buffett investment advisor agent"
}
...
variable "create_agent_version" {
  description = "Whether to create a version snapshot of the agent after changes"
  type        = bool
  default     = false
}