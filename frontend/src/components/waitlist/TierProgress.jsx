...
const TIERS = [
  ...
  { threshold: 10, label: '3 Months Free', icon: Crown, reward: '3 months free Plus' },
];
    ...
    <div className="w-full">
      ...
      <div className="relative mb-8">
        <div className="h-2 bg-sand-200 dark:bg-warm-800 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-rust-500 to-rust-400 rounded-full transition-all duration-700 ease-out"
            ...
            return (
              ...
              >
                ...
                <span className={`mt-2 text-xs font-medium text-center whitespace-nowrap ${
                  achieved ? 'text-rust-500' : 'text-sand-500 dark:text-warm-300'
                }`}>
