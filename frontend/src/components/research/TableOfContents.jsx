        ...
        <div key={part} className="mb-2">
          ...
          <button
            ...
            className={`
              ...
              hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors rounded-md mx-1
          ...
          >
            ...
            {/* Progress badge */}
            <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-slate-200 dark:bg-slate-600 text-slate-600 dark:text-slate-300">
